package com.example.finalmobileproject.Adapter;
...
import com.example.finalmobileproject.TaskDetailsActivity;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.MyViewHolder> {
    ...
    private com.example.finalmobileproject.MainActivity activity;
    ...
    public TaskAdapter(DataBaseHelper myDB, com.example.finalmobileproject.MainActivity activity) {
    ...
    private void scheduleNotification(String taskTitle, long triggerTime) {
        ...
        intent.putExtra(AlarmClock.EXTRA_MESSAGE, "N'oubliez pas de compléter cette tâche: " + taskTitle);
        Calendar calendar = Calendar.getInstance();
